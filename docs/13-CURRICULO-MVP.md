...
- Ilustração: desde 2026-09-13, as 12 lições do currículo têm imagem em todas as 4 cenas, geradas manualmente via Gemini a partir dos prompts preparados em `docs/14-PROMPTS-DE-IMAGEM-LICOES.md` (lições 1 a 5 em 2026-09-12; lições 6 a 12, incluindo as 3 cenas restantes da lição 7, em 2026-09-13).
- Narração em áudio: 43 das 48 cenas integradas (arquivo por cena + `audioSrc`, sem alinhamento por palavra — ver fluxo simples em `docs/09-PADRAO-DE-LICOES.md`). Faltam apenas a cena "Agora é sua vez" da lição 4 (`business-hours-matter`) e as 4 cenas da lição 12 (`choose-your-next-action`) — roteiros e passo a passo prontos em `docs/09`, geráveis em qualquer IA de voz.
