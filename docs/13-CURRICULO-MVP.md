...
- Narração em áudio: **48 das 48 cenas integradas** em MP3 com voz única (edge-tts `pt-BR-AntonioNeural`, 2026-09-19 — lote N1–N48 de `docs/18-SUBSTITUICAO-NARRACAO-COMPLETA.md` concluído, `.wav` antigos apagados). Falta a aprovação por escuta (checklist no mesmo documento).
...
| 12 | 5. Descubra o que melhorar | Escolha sua próxima ação (`choose-your-next-action`) | Fechar o currículo mínimo transformando reflexão em rotina: escolher e executar uma melhoria concreta. | Lição 11 | Execute uma melhoria escolhida (`execute-one-improvement`) | O usuário executa uma das 3 melhorias identificadas na missão anterior. | **Implementada** (imagem nas 4 cenas; narração em áudio integrada nas 4 cenas; sem legenda visível) |

**As 12 lições e 12 missões do currículo estão implementadas**, todas as 12 têm imagem nas 4 cenas e todas as 48 cenas têm narração em áudio integrada (MP3, voz única, 2026-09-19 — ver `docs/18-SUBSTITUICAO-NARRACAO-COMPLETA.md`). Falta a aprovação por escuta dos áudios (checklist no mesmo documento). Nenhuma lição tem legenda visível — a legenda foi removida da interface em 2026-09-12 a pedido do usuário (ver `docs/07-CHANGELOG.md`).
