...
- **P0 — Produto Free:** ✅ currículo (12 lições, 43 das 48 cenas com áudio — faltam 1 cena de `business-hours-matter` e as 4 de `choose-your-next-action`), ✅ QR Code/link de avaliações, ✅ onboarding (coleta de nome/segmento do negócio, 2026-09-14), ✅ landing page pública (2026-09-13/14) e ✅ deploy real no Firebase Hosting (2026-09-13) concluídos; restam 5 cenas sem áudio e as dívidas da auditoria editorial (`docs/16-AUDITORIA-EDITORIAL-LICOES.md`).
