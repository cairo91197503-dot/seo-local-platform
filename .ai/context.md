...
1. ✅ currículo/lições (Fase 3) — concluído em 2026-09-12: as 12 lições e 12 missões do currículo do MVP (`docs/13-CURRICULO-MVP.md`) estão implementadas em texto. Produção audiovisual: imagens prontas para as lições 1-5 (faltam 6, 8-12); roteiros de narração (`narration.script`) escritos para as 48 cenas e pipeline de mídia habilitado para as 12 lições em 2026-09-12 — a pedido explícito do usuário, próximo passo é gerar o áudio de verdade na VM (Piper/whisper.cpp);
